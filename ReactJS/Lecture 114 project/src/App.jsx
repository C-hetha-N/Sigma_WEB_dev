...
function App() {
  ...
  const handleCheckbox = (e) => { 
    ...
    return (
      <>
        <Navbar />
        <div className="mx-4 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-200 min-h-[80vh] max-w-xl ">
        ...
        {/* <div className="container mx-auto my-4 p-6 max-w-xl min-h-[80vh] bg-violet-200 rounded-xl"> */}
          ...
          <div className='addTodo'>
            ...
            <div className='inputTodo flex gap-2 m-2'>
              <input onChange={handleChange} value={todo} type="text" className='rounded-2xl w-11/12' />
